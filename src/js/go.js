...
import { setTimeout, log } from 'core-js/library/web/timers';
  // preload
  ...
  function go() {
    typish('#typer')
      ...
      .type('今天教你这个蠢逼写下代码咯', '<span class="note">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .wait(10)
      .type('骚等。。。', '<span class="note">') 
      .wait(10)
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'巴傻逼儿'", '<span class="green">')
      .wait(15)
      .del(6)
      .type("'巴诗绘'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // 珊珊
      .type('0000', '<span class="blank">')
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'2014-05-07'", '<span class="green">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .type('}', '<span class="gray">')
      .type('0', '<br>')
      ...
      // 四个空格
      .type('0000', '<span class="blank">')
      .type('身高', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'1.6m'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // width
      .type('0000', '<span class="blank">')
      .type('体重', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'50kg'", '<span class="green heartBg">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // margin
      .type('0000', '<span class="blank">')
      .type('兴趣', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'买买买'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .type('}', '<span class="gray">')
  ...
  function count() {
    ...
    new Promise((resolve, reject) => {
      const date = new Date(2014,5,7,0,0,0);
      let end = new Date();
      let seconds = ((+end) - (+date)) / 1000;
